...
def ledgercreations(request):
    if request.method == 'POST':
        ...
        capital_amount=request.POST['capital_amount']
        if capital_amount=="":
           capital_amount=None
...
def trialbalance(request):
    ...
    'cpsum1':cpsum1,'cpsum2':cpsum2,'loan':loan,'loan2':loan2,'crl':crl,'crl2':crl2,'fxa':fxa,'fxa2':fxa2,'tot':tot,'cltot':cltot,'clsum':clsum,'ctot':ctot,
